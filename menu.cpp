...
int amounts[5] = {sizeof(menu) / sizeof(menu[0]), sizeof(fruits) / sizeof(fruits[0]), sizeof(herbs) / sizeof(herbs[0]), sizeof(houseplants) / sizeof(houseplants[0]), sizeof(vegetables) / sizeof(vegetables[0])};
